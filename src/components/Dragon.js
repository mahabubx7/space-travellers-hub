    ...
    <li>
      <figure className={styles.figure}>
        ...
        <div className={styles.details}>
          ...
          {reserved ? <button className={styles.btn} type="button" onClick={() => handleClick(id)}>Cancel Reservation</button> : <button type="button" className={styles.btn} onClick={() => handleClick(id)}>Reserve Rocket</button>}
        </div>
      </figure>
    </li>
  );
